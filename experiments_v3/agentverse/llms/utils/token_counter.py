...
def count_string_tokens(prompt: str = "", model: str = "meta-llama/Llama-3.1-8B-Instruct") -> int:
    from transformers import AutoTokenizer

    hf_model_name = LOCAL_LLMS_MAPPING.get(model.lower(), {}).get("hf_model_name", model)
    encoding = AutoTokenizer.from_pretrained(hf_model_name)
...
def count_message_tokens(messages: Union[Dict, List[Dict]], model: str = "meta-llama/Llama-3.1-8B-Instruct") -> int:
